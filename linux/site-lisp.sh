...
./install-eaf.py --force -i emacs-application-framework browser pdf-viewer file-manager git pyqterminal file-sender image-viewer video-player video-editor org-previewer markdown-previewer jupyter
